...
def my_callback(channel):  
    print "falling edge detected on 20 (channel: %d)" % channel
  
def my_callback2(channel):  
    print "falling edge detected on 21 (channel: %d)" % channel
...
GPIO.add_event_detect(21, GPIO.FALLING, callback=my_callback2, bouncetime=300)  
